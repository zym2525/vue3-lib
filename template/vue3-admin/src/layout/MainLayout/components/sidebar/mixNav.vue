...
const { logout, toggleSideBar, handleResize, menuSelect, resolvePath, pureApp, usename } = useNav()
      ...
      >
        <template #title>
          <el-icon v-show="route.meta.icon" :class="route.meta.icon">
            <component :is="useRenderIcon(route.meta && route.meta.icon)"></component>
          </el-icon>
        ...
        <template #dropdown>
          <el-dropdown-menu class="logout">
            <el-dropdown-item @click="logout">
              <IconifyIconOffline icon="logout-circle-r-line" style="margin: 5px" />退出登陆
            </el-dropdown-item>
          </el-dropdown-menu>
        </template>
      </el-dropdown>
