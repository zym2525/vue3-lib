...
import { getAttendeeList, exportAttendees } from '@/api/official'
import type {
  IAttendee,
  AttendeeListInput,
  AttendeeListWithPageInput,
...
const getList = () => {
  try {
    const params: AttendeeListWithPageInput = {
      pageModel: {
